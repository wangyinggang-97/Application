...
static void SPI_Flash_ReadFlashID()
{
    ...
    printf("The JEDEC ID of SPI flash is 0x%.6X", SPI_Flash.JedecID);
    //	sprintf((char *)tuf,"The JEDEC ID of SPI flash is 0x%.6X",SPI_Flash.JedecID);
    //    TFT_LCD.LCD_ShowString(0,0,tuf,Color_WHITE,Color_BLACK,ASCII_font_16);
    ...
    ***/
    ...
    {
    case 0xEF4015:
        printf("Flash芯片型号为W25Q16JV-IQ/JQ， 16M-bit /2M-byte\r\n");
        break;
    case 0xEF4017:
        printf("Flash芯片型号为W25Q64JV-IQ/JQ， 64M-bit /8M-byte\r\n");
        break;
    case 0xEF4018:
        printf("Flash芯片型号为W25Q128JV-IQ/JQ，128M-bit/16M-byte\r\n");
        break;
    default:
        printf("Flash芯片型号未知\r\n");
    }
