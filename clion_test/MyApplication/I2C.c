...
/* Private variables----------------------------------------------------------*/
static void Init(void);  //I2C初始化
static void Start(void); //I2C起始信号
static void Stop(void);  //I2C停止信号
static ACK_Value_t Write_Byte(uint8_t);      //I2C写字节
static uint8_t     Read_Byte (ACK_Value_t);  //I2C读字节
